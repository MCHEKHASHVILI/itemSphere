...
var mobileSearchInput = document.querySelector('.m-header__search--input');
...
var mobileSearchBTN = document.querySelector('.header__mobile__btns--search');
mobileSearchBTN && mobileSearchBTN.addEventListener("click", function (e) {
  document.querySelector('.header__search__bar').style.display = "block";
}); // mobile

var mobileSearchCancel = document.querySelector('.m-search-cancel');
mobileSearchCancel && mobileSearchCancel.addEventListener("click", function (e) {
  document.querySelector('.header__search__bar').style.display = "none";
});
var registerOpen = document.querySelector('.register-open');
...
var registerToLogin = document.querySelector('.register__link--btn');
...
var registerStepFunc = $('.register__btns--btn');
...
var ActiveWinodw = document.querySelectorAll(".click-open");
ActiveWinodw && ActiveWinodw.forEach(function (e) {
  var elementClick = e.getAttribute("data-active");
  e.addEventListener("click", function () {
    document.querySelectorAll('.open-active').forEach(function (e) {
      var elementActive = e.getAttribute("data-active");
...
var CloseActiveWindow = document.querySelectorAll(".close-click");
...
var CloseBgActiveWindow = document.querySelectorAll(".popup");
...
window.addEventListener('DOMContentLoaded', function (event) {
  var llet = document.querySelector('.header').clientHeight;
  document.querySelector('.head-menu--fix').style.top = "".concat(llet, "px");
});
$(function () {
...
/***/ "./public/js/frontJs/pagination.js":
/*!*****************************************!*\
  !*** ./public/js/frontJs/pagination.js ***!
  \*****************************************/
/***/ (() => {
...
function PageMargin() {
  if (marginPageCount > 10 || marginPageCount < -10) {
    $('.touch').css('margin-left', "".concat(marginPageCount * 2, "px"));
  } else {
    $('.touch').css('margin-left', "".concat(0, "px"));
  }
}

var pageNamesData = ['market-touch', 'shop-touch', 'social-program-touch', 'charities-touch'];
var TransformActive = false;

function pageName(n) {
  for (var i = 0; i < pageNamesData.length; i++) {
    var element = pageNamesData[i];
    ...
    if ($('.touch').hasClass(element)) {
      ...
      if (page > 0 || page == 0 && page <= pageNamesData.length - 1 || page == pageNamesData.length - 1) {
        ...
        PageMargin();
        setTimeout(function () {
          location.href = "".concat(pageNamesData[page], ".html");
        }, 500);
      }
    }
  }
...
function MainPageSliderFunction() {
  var blogMenu = document.querySelector('.blog-page__menu');
  ...
  var ProdouctSlider = document.querySelectorAll('.products-slider');
  ProdouctSlider && ProdouctSlider.forEach(function (item, key) {
    item.classList.add("products-slider-".concat(key));
    var ProdouctSliderFunction = $(".products-slider-".concat(key));
    ProdouctSliderFunction && new Splide(".products-slider-".concat(key), {
      type: 'slide',
      autoplay: false,
      perPage: 5,
  ...
  var ProdouctCartSlider = document.querySelectorAll('.cart-popup .products-slider');
  ProdouctCartSlider && ProdouctCartSlider.forEach(function (item, key) {
    item.classList.add("products-slider-".concat(key));
    var ProdouctCartSliderFunction = $(".products-slider-".concat(key));
    ProdouctCartSliderFunction && new Splide(".cart-popup .products-slider-".concat(key), {
      type: 'slide',
      autoplay: false,
      perPage: 1,
      // padding: { left: 9, right: 9 },
  ...
  var SocialSlider = $('.social-program-slider');
  ...
  var ItemSlider = document.querySelectorAll('.item-slider');
  ItemSlider && ItemSlider.forEach(function (item, key) {
    item.classList.add("item-slider-".concat(key));
    var ItemSliderFunction = $(".item-slider-".concat(key));
    ItemSliderFunction && new Splide(".item-slider-".concat(key), {
      type: 'loop',
      perPage: 1,
      autoplay: false,
      arrows: 'slider',
  ...
  var OurShopSlider = $('.ourshop-slider');
  ...
  var DeliverSlider = $('.delivered-slider');
 ...
 */
// require('./bootstrap');
__webpack_require__(/*! ../../public/js/frontJs/function */ "./public/js/frontJs/function.js");

__webpack_require__(/*! ../../public/js/frontJs/pagination */ "./public/js/frontJs/pagination.js");

__webpack_require__(/*! ../../public/js/frontJs/slider */ "./public/js/frontJs/slider.js");

__webpack_require__(/*! ../../public/js/frontJs/splide */ "./public/js/frontJs/splide.js"); // window.Vue = require('vue').default;

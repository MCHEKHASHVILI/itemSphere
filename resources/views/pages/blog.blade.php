            ...
            <div class="col-12 col-lg-4">
                <div class="blog-page__item">
                    ...
                    <figure class="blog-page__item--cover">
                        <img src="{{ asset('assets/img/iphone-banner-2.jpg') }}" alt="">
                    </figure>
                    <div class="blog-page__item--date regular d-flex align-items-center">
                        <div class="d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/img/svg/timer-line.svg') }}" alt="">
                        </div>
                        6 min
                    </div>
                        ...
                        <ul class="d-flex align-items-center item-btns">
                            <li class="header__btns--item item-btns__item regular d-flex align-items-center">
                                <a href="" class="header__btns--link item-btns__item--btn d-flex align-items-center justify-content-center">
                                    <img src="{{ asset('assets/img/svg/like-item.svg') }}" alt="" class="item-btns__item--icon convert-svg">
                                </a>
                                300
                            </li>
                            <li class="header__btns--item item-btns__item regular d-flex align-items-center">
                                <a href="" class="header__btns--link item-btns__item--btn d-flex align-items-center justify-content-center">
                                    <img src="{{ asset('assets/img/svg/socshare.svg') }}" alt="" class="item-btns__item--icon convert-svg">
                                </a>
                                200
                            </li>
                        </ul>
            ...
            <div class="col-12">
                <div class="banner-larg">
                    <a href="/" class="banner-larg__cover">
                        <img src="{{ asset('assets/img/organization-cover.png') }}" class="banner-larg__cover--img" alt="">
                    </a>
                </div>
            </div>

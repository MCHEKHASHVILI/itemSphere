                ...
                <div class="row flex-wrap-reverse flex-wrap">
                    <div class="col-lg-5">
                        <div class="footer__content--left">
                            <img src="{{ asset('assets/img/svg/footer-logo.svg') }}" alt="" class="footer__content--logo d-none d-lg-block">
                            ...
                            <div class="footer__content--app d-flex">
                                <img src="{{ asset('assets/img/applestore.png') }}" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 d-lg-none">
                                <div class="footer__payment d-flex align-items-center">
                                    ...
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/img/svg/footer-icon/visa.svg') }}" alt="" class="footer__payment--icon">
                                        <img src="{{ asset('assets/img/svg/footer-icon/master.svg') }}" alt="" class="footer__payment--icon">
                                        <img src="{{ asset('assets/img/svg/footer-icon/cash.svg') }}" alt="" class="footer__payment--icon">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <ul class="footer__menu">
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/mobile.svg') }}" alt="">
                                            +995 599 88 32 53
                                        </a>
                                    </li>
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/mail.svg') }}" alt="">
                                            info@itemssphere.ge
                                        </a>
                                    </li>
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/location.svg') }}" alt="">
                            ...
                            <div class="col-lg-4">
                                ...
                                <ul class="footer__menu d-flex">
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/fb.svg') }}" alt="">
                                        </a>
                                    </li>
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/instagram.svg') }}" alt="">
                                        </a>
                                    </li>
                                    <li class="footer__menu--item d-flex">
                                        <a href="" class="footer__menu--link regular d-flex align-items-center">
                                            <img src="{{ asset('assets/img/svg/footer-icon/in.svg') }}" alt="">
                                        </a>
                                    </li>
                                </ul>
    ...
    <div class="popup open-active d-lg-none align-items-center justify-content-center" data-active="mobile-popup-menu">
        <div class="popup__container">
            <button class="popup__close close-click" data-active="mobile-popup-menu">
                <img src="{{ asset('assets/img/svg/popup-close.svg') }}" alt="" class="d-none d-lg-block">
                <img src="{{ asset('assets/img/svg/popup-back-btn.svg') }}" alt="" class="d-block d-lg-none">
            </button>
        ...
        <div class="popup__container">
            ...
            <div class="sign-in login">
                ...
                <form class="sign-in__form">
                    <label class="sign-in__form--label d-flex align-items-center">
                        ...
                        <img src="{{ asset('assets/img/svg/username.svg') }}" alt="" class="sign-in__form--icon">
                    </label>
                    <label class="sign-in__form--label d-flex align-items-center">
                        <input type="password" class="sign-in__form--input regular" placeholder="Password">
                        <img src="{{ asset('assets/img/svg/key.svg') }}" alt="" class="sign-in__form--icon">
                    </label>
                ...
                <div class="sign-in__or d-flex align-items-center justify-content-center">
                    ...
                    <button class="sign-in__or--btn">
                        <img src="{{ asset('assets/img/svg/login-google-btn.svg') }}" alt="">
                    </button>
                    <button class="sign-in__or--btn">
                        <img src="{{ asset('assets/img/svg/login-fb-btn.svg') }}" alt="">
                    </button>
                </div>
            ...
            <div class="sign-in register">
                ...
                <form data-step="1" class="sign-in__form register__step active">
                    ...
                    <label class="sign-in__form--label d-flex align-items-center">
                        <input type="text" class="sign-in__form--input regular" placeholder="Email">
                        <img src="{{ asset('assets/img/svg/input-mail.svg') }}" alt="" class="sign-in__form--icon">
                    </label>
                    <label class="sign-in__form--label d-flex align-items-center">
                        <input type="password" class="sign-in__form--input regular" placeholder="Password">
                        <img src="{{ asset('assets/img/svg/key.svg') }}" alt="" class="sign-in__form--icon">
            ...
            <div class="cart-popup__list">
                <div class="cart-popup--padding cart-item d-flex justify-content-start">
                    <figure class="cart-item__img d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/img/iphone-white.jpg') }}" alt="">
                    </figure>
                    <div class="cart-item__content d-flex">
                        ...
                        <div>
                            <button class="cart-item--btn d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/svg/header-btn/bar-wishlist.svg') }}" alt="">
                            </button>
                            <button class="cart-item--btn d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/img/svg/trash.svg') }}" alt="">
                            </button>
                        </div>
                    </div>
                </div><!-- item end -->
                            ...
                            <div class="shop-detail__window-banner">
                                ...
                                <div class="shop-detail__donation">
                                    <figure class="shop-detail__window-banner--icon d-flex justify-content-center">
                                        <img src="{{ asset('assets/img/donat-icon.png') }}" alt="">
                                    </figure>
                                    ...
                                    <button class="shop-detail__donation--send-sms d-flex align-items-center justify-content-center bold">
                                        <img src="{{ asset('assets/img/svg/sms-green.svg') }}" alt="">
                                        Send Massage
                                    </button>
                                </div>
                            </div>
            ...
            <label class="element__check d-flex align-items-center cart-popup--padding">
                <div>
                    ...
                    <span class="element__check--checked">
                        <img src="{{ asset('assets/img/svg/checked.svg') }}" alt="">
                    </span>
                </div>
